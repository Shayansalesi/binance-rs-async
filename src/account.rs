...
/// Whether replace order is allowed if cancel order fails
...
/// additional mandatory parameters are determined by order_type the same as in order.
/// Either the cancel_orig_client_order_id or cancel_order_id must be provided. If both are provided, cancel_order_id takes precedence.
#[derive(Default, Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct CancelReplace {
    /// The trading pair symbol, must be valid
    pub symbol: String,
    /// The side of the new order
    pub side: OrderSide,
    #[serde(rename = "type")]
    ...
    pub quantity: Option<f64>,
    /// The quantity of the new order in the quote currency
    pub quote_order_qty: Option<f64>,
    /// The price of the new order
    pub price: Option<f64>,
    /// Used to uniquely identify this cancel. Automatically generated by default
    pub cancel_new_client_order_id: Option<String>,
    /// The client-provided id of the order being cancelled
    ...
    /// The client-defined id of the new order
    pub new_client_order_id: Option<String>,
    /// The stop price of the new order
    pub stop_price: Option<f64>,
    /// The iceberg quantity of the new order
    pub iceberg_qty: Option<f64>,
    /// Ignore
    pub new_order_resp_type: Option<OrderResponse>,
    /// Cannot be greater than 60000
